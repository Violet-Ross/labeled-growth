...
def main():
    ...
    #estimates1, likelihoods1 = sem.SEM(GH1, s_intial, 1600, 0.01, 0.001)
    GH1 = sem.generate_hypergraph(g1_true_theta, 50)
    estimates1, likelihoods1 = sem.SEM_with_likelihood(GH1, s_intial, 16, 0.01, 0.001)
    ...
    # estimates2, likelihoods2 = sem.SEM(GH2, s_intial, 1600, 0.01, 0.001)
    GH2 = sem.generate_hypergraph(g2_true_theta, 5)
    estimates2, likelihoods2 = sem.SEM_with_likelihood(GH2, s_intial, 16, 0.01, 0.001)
    ...
    # estimates3, likelihoods3 = sem.SEM(GH3, s_intial, 1600, 0.01, 0.001)
    GH3 = sem.generate_hypergraph(g3_true_theta, 5)
    estimates3, likelihoods3 = sem.SEM_with_likelihood(GH3, s_intial, 16, 0.01, 0.001)
    ...
    # estimates4, likelihoods4 = sem.SEM(GH4, s_intial, 1600, 0.01, 0.001)
    GH4 = sem.generate_hypergraph(g4_true_theta, 5)
    estimates4, likelihoods4 = sem.SEM_with_likelihood(GH4, s_intial, 16, 0.01, 0.001)
    ...
    # estimates1 = sem.SEM_without_likelihood(GH1, s_intial, 2000, 0.01, 0.001)
    GH1 = sem.generate_hypergraph(g1_true_theta, 10)
    estimates1 = sem.SEM_without_likelihood(GH1, s_intial, 10, 0.01, 0.001)
    with open('throughput/graph1_sem_ests_extended.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows(estimates1)
    print("Graph 2")
    # GH2 = sem.generate_hypergraph(g2_true_theta, 2000)
    # estimates2 = sem.SEM_without_likelihood(GH2, s_intial, 2000, 0.01, 0.001)
    GH2 = sem.generate_hypergraph(g2_true_theta, 10)
    estimates2 = sem.SEM_without_likelihood(GH2, s_intial, 10, 0.01, 0.001)
    with open('throughput/graph2_sem_ests_extended.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows(estimates2)
    print("Graph 3")
    # GH3 = sem.generate_hypergraph(g3_true_theta, 2000)
    # estimates3 = sem.SEM_without_likelihood(GH3, s_intial, 2000, 0.01, 0.001)
    GH3 = sem.generate_hypergraph(g3_true_theta, 10)
    estimates3 = sem.SEM_without_likelihood(GH3, s_intial, 10, 0.01, 0.001)
    with open('throughput/graph3_sem_ests_extended.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows(estimates3)
    print("Graph 4")
    # GH4 = sem.generate_hypergraph(g4_true_theta, 2000)
    # estimates4 = sem.SEM_without_likelihood(GH4, s_intial, 2000, 0.01, 0.001)
    GH4 = sem.generate_hypergraph(g4_true_theta, 10)
    estimates4 = sem.SEM_without_likelihood(GH4, s_intial, 10, 0.01, 0.001)
