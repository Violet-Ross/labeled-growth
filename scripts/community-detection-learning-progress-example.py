...
for i in range(2): 
    ...
    sns.lineplot(data=sub, x="diff", y=col_to_plot, hue="theta_3", palette="inferno", ax=axarr[i], alpha = 0.5, legend = i == 0, linewidth = 2.5)
...
palette = sns.color_palette("inferno_r", n_colors=sub["theta_3"].nunique())
