...
The heatmap in Figure \ref{fig:synthetic_sem} shows that the divergence between true and estimated parameters varies among the generating parameters.
...
The coauthorship data, meanwhile, falls on the line of equality for the edge copy and external node addition mechanisms, but is plotted below the line of equality in the novel node addition panel.
...
The emails hypergraph falls in the het

\violet{Discuss intuition behind enron}
