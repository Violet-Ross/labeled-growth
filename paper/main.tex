...
The SEM algorithm continues iterating until the stopping criterion is met. In our experiments, the stopping criterion is met when each of the current parameter estimates $\at{\hat{\paramvector}}{\ell}$ is within [THRESH] of the [LENGTH] preceding estimates of the corresponding parameter. \phil{Violet, can you fill these in?}
...
\begin{figure*}[t]
    ...
    \caption{
        ...
        For each set of parameters, 20 indepedent hypergraphs are generated according to the model  and SEM is performed independently on each. \phil{Violet, for how many simulation steps?}
