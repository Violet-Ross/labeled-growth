...
\hline
\multicolumn{2}{c}{$\same{\copyrate{}}$} & \multicolumn{2}{c}{$\opp{\copyrate{}}$} & \multicolumn{2}{c}{$\same{\extantrate}$} & \multicolumn{2}{c}{$\opp{\extantrate}$} & \multicolumn{2}{c}{$\same{\novelrate}$} & \multicolumn{2}{c}{$\opp{\novelrate}$} \\
\hline
$v$ & $\varepsilon$ & $v$ & $\varepsilon$ & $v$ & $\varepsilon$ & $v$ & $\varepsilon$ & $v$ & $\varepsilon$ & $v$ & $\varepsilon$ \\
\hline
...
\caption{True parameter values and SEM estimation error ($\varepsilon = \hat{\theta} - \theta$) for each graph.}
\label{tab:sem_estimates}
\end{table}

\violet{Hate the presentation of this (table 2). Thinking of better ways to convey this information.}
...
\appendix
    ...
    \section{Algorithmic specification for simulated annealing}\label{sec:simulated-annealing-algorithm-spec}
