...
Figure \ref{fig:synthetic_sem} shows the performance of SEM on synthetic data. 
...
Figure \ref{fig:synthetic_sem} demonstrates the accuracy of the SEM-inferred parameter estimates for each of these synthetic hypergraphs.
...
\begin{figure*}[t]
    ...
    \caption{
        ...
        Each entry in the heatmap corresponds to a set of parameters $\paramvector$, which can be found in Appendix \ref{sec:SEM-appendix}.        For each set of parameters, five indepedent hypergraphs are generated according to the model and SEM is performed independently on each.
