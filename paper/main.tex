...
\phil{Violet, this is your spot! Descriptions of methods/algorithms should go here, results are for later. }
    ...
    We first consider the problem of learning the parameter vector $\paramvector = (\eta_+, \eta_-, \lambda_+, \lambda_-, \gamma_+, \gamma_-)$ given an observed hypergraph $\hypergraph$ with sequential edge indices and known node labels $\vz$.
