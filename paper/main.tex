...
\phil{Standardize on ``external'' vs. ``extant''.}
...
\begin{figure*}[t]
    ...
    \caption{
        ...
        For each set of parameters, 20 independent 2000-edge hypergraphs are generated according to the model and SEM is performed independently on each. 
