...
\appendix
    ...
    \subsection{Implementation Details}
        ...
        For all runs of SEM, the initial learning rate was $\lr^{(0)} = 0.01$, which exponentially decayed over iterations according to the exponent 0.001.
        \phil{Violet, can we make this a bit more mathematical?}
