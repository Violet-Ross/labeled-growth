...
\begin{figure}[t]
    ...
    \caption{Model parameters inferred via SEM for six empirical higher-order networks. The initial learning rate was $\lr^{(0)} = 0.01$, which exponentially decayed over iterations according to the exponent 0.001.}
