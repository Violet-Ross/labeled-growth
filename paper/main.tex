...
\begin{table}
    ...
    \resizebox{\columnwidth}{!}{
        ...
        \toprule
        & $n$ & $m$ & $\langle d \rangle$ & $\langle k \rangle$ & Nodes are & Edges mean & Labels represent\\
        \midrule
        \texttt{senate-bills} \cite{fowler2006connecting,fowler2006legislative,chodrowGenerativeHypergraphClustering2021} & 100 & 200 & 2.0 & 4.0 & Cosponsored bills & Political parties\\
        \texttt{house-bills} &  &  &  \\
        \texttt{high-school} &  &  &  \\
        \texttt{primary-school} &  &  &  \\
        \texttt{coauthorship} &  &  &  \\
        \texttt{emails} &  &  &  \\
        \bottomrule
        \end{tabular}
