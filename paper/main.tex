...
\section{Model Description}
    ...
    Blah blah blah The Model. Establish notation here, use macros and propagate to sections below. 


\subsection{Long-Run Dynamics}


\subsubsection{Joint Distribution of Edge Labels} \label{sec:joint-distribution}
...
\subsubsection{Degree Distribution}
    ...
    So, we have 
    \begin{align}
        \brackets{d} = \frac{\brackets{k}}{\gamma_- + \gamma_+} \;. \label{eq:average-degree}
    \end{align}
    ...
    \begin{align}
        \sigma_0 \triangleq \brackets{\frac{k_0}{k}\paren{1 + \eta_+(k_0 - 1)} + \frac{k_1}{k} \eta_- k_0} = 1 + \eta_+ \squarebrackets{\rho_0 + \rho_1 - 1} + \eta_- \rho_{01}\;. 
    \end{align}
    Similarly, the expected number of nodes of label 1 copied into the new edge $e$ from $f$ is 
    \begin{align}
        \sigma_1 \triangleq \brackets{\frac{k_1}{k}\paren{1 + \eta_+(k_1 - 1)} + \frac{k_0}{k} \eta_- k_1} = 1 + \eta_+ \squarebrackets{\rho_0 + \rho_1 - 1} + \eta_- \rho_{01}\;. 
    \end{align}
    We let 
    \begin{align}
        \sigma \triangleq \sigma_0 + \sigma_1 = 1 + \eta_+(\rho_0 + \rho_1 - 1) + 2\eta_- \rho_{01}\;.
    \end{align}
    Importantly, $\sigma$ depends only on the parameters and the moments of the joint distribution $p(k_0, k_1)$, which can be computed via linear algebra as described in \Cref{sec:joint-distribution}.
