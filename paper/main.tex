...
We also used our method to infer parameters for six empirical hypergraph datasets. 
...
\begin{table}
    ...
    \resizebox{\columnwidth}{!}{
        ...
        \toprule
        & $n$ & $m$ & $\langle d \rangle$ & $\langle k \rangle$ & Source\\
        \midrule
        \texttt{senate-bills} & 100 & 200 & 2.0 & 4.0 & [1]\\
        \texttt{house-bills} &  &  &  \\
        \texttt{high-school} &  &  &  \\
...
Some hypergraphs, like the primary-school network, appear on or near the line of equality in all three panels, suggesting that there is little to no homophily present in any of the growth mechanisms with respect to the chosen binary labels.
The coauthorship data, meanwhile, falls on the line of equality for the edge copy and external node addition mechanisms, but is plotted above the line of equality in the novel node addition panel.
This indicates that for the coauthorship network, homophily with respect to gender is present in one of the three growth mechanisms.
