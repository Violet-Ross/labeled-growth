...
\section{Introduction}
    ...
    \end{align}
    Many generative models for community detection fall into this category, including all stochastic blockmodels known the authors. 
    The conditional independence property \cref{eq:edge-independence} is extremely useful for computation, as factorizability of the likelihood enables many efficiencies in various inference algorithms. 

    Edge independence, however, is a strong and often unrealistic assumption for modeling hypergraph data. 
    A parallel line of work has found that polyadic data sets often contain significant edge correlations \cite{bensonSimplicialClosureHigherorder2018}, typically in the form of \emph{similarity between interactions}.
    ...
    In this article, we propose a simple generative model of hypergraph growth with community structure. 
    Our model builds on the Hyperedge Copy Model (HCM) of \cite{heEdgeCorrelationsLink2025}. 
...
\subsection{Generative Models for Community Detection}

    Many algorithms for hypergraph community detection extend well-known algorithms for graphs like modularity maximization \cite{chodrowGenerativeHypergraphClustering2021}, 
    expectation-maximization \cite{ruggeriCommunityDetectionLarge2023}, and message-passing \cite{ruggeri2024message} 
    spectral clustering \cite{chodrowNonbacktrackingSpectralClustering2023,fernandez2026achieving,li2026higher}, and information-theoretic optimization methods \cite{kritschgauCommunityDetectionHypergraphs2024}. 
    

\subsection{Mechanistic Models of Hypergraph Formation}

\subsection{The Role of Edge-Independence}
