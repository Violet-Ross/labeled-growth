...
We performed SEM accross a set of hypergraphs which were generated with varying amounts of homophily in each of the three steps of creating a new edge: the edge copy step, the external node addition step, and the novel node addition step.
