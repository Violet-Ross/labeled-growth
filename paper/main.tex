...
\section{Appendix}
    ...
    \section{Sufficient Statistics for Stochastic Expectation-Maximization} \label{sec:sufficient-statistics}
        ...
        We describe the function $\sigma$ which computes the conditional sufficient statistics for the parameters $\paramvector = (\same{\copyrate{}}, \opp{\copyrate{}}, \same{\extantrate{}}, \opp{\extantrate{}}, \same{\novelrate{}}, \opp{\novelrate{}})$ given an observed edge $e$, a candidate parent edge $f$, a candidate seed node $u$, and the node labels $\vz$. 
