...
\begin{figure}
    ...
    \caption{
        ...
        In each of the three panels, a single one of these parameters is varied while the others are held fixed at their default values. 
...
\section{Discussion}
    ...
    We have also demonstrated that, in some circumstances, maximum-likelihood inference of node labels $\vz$ via simulated annealing can outperform standard community detection methods on both synthetic and empirical data sets.
    
    There are several directions for future work. 
    Most obviously, although our results show that maximum-likelihood inference is a theoretically reasonable approach for community detection in this model, the simulated annealing method we have used is impractically expensive on data sets of even relatively modest size. 
