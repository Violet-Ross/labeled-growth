...
\begin{figure}
    ...
    \caption{Community detection results on empirical datasets.}
...
\frannie{Box plot to be included}\label{fig:simulated-annealing-box-plot}
...
In \Cref{fig:simulated-annealing-box-plot}, we observe that simulated annealing outperforms both greedy-modularity and spectral clustering on senate bills in all 10 runs in ARI.  
On the primary school dataset, simulated annealing performs comparably in ARIf to the competitor methods, with a slightly lower average over the ten runs.  
However, simulated annealing performs worse on the high school dataset in ARI compared to its competitors.
While the computational performance of simulated annealing presents a difficulty in its application, these results provide evidence to support the idea that our model provides a more effective model of the formation of the senate bills dataset compared to modularity's mathematical equivalent, the stochastic block model, and spectral clustering.
