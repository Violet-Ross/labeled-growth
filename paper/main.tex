...
\section{Model Description} \label{sec:model-description}
    ...
    \begin{figure}
        ...
        The model begins with two disjoint label-homogeneous edges and is run for 25 timesteps. \phil{
            this fig is ok but small and a bit hard to read. It might make sense to take just a single one of these and make it larger, and combine with a plot that shows something like modularity as a function of parameters. 
            However, stacking them vertically would also be a possibility. 
        }
        } \label{fig:examples}
    \end{figure}
