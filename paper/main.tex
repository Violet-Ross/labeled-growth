...
\phil{Frannie or Violet (can't remember which one of you did this), please briefly describe how you did the filtering in the \texttt{primary-school} and \texttt{high-school} datasets to remove edges. I think it was that you removed identical edges observed within the minimum time resolution of data collection, but please confirm and describe.}
...
\begin{figure}
    ...
    \caption{Test caption} \label{fig:community-synthetic}
\end{figure}

We evaluate our simulated annealing algorithm on a range of small synthetic data sets under two conditions, shown in \Cref{fig:community-synthetic} \phil{Phil needs to repopulate this}. 
...
\phil{
    Frannie, you can incorporate these references into your discussion: 
    Spectral clustering: \cite{luxburg2007tutorial}, modularity: \cite{clauset2004finding}, ARI: \cite{hubert1985comparing}. 
}
