...
\begin{figure}[t]
    ...
    The color of an entry in the heatmap represents the mean KL divergence over the five simulations for that set of parameters.} \label{fig:empirical_sem}
\end{figure}

\begin{figure}[t]
    \includegraphics[width=0.5\textwidth]{../fig/empirical_sem.png}
    \caption{Model parameters inferred via SEM for six empirical higher-order networks. The initial learning rate was $\lr^{(0)} = 0.01$, which exponentially decayed over iterations according to the exponent 0.001.} \label{fig:empirical_sem}
\end{figure}
