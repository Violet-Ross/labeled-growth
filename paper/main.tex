...
\frannie{Ref greedy-modularity and spectral clustering} Spectral \cite{luxburg2007tutorial}, modularity \cite{clauset2004finding}. 
\frannie{Ref ARI?} \cite{hubert1985comparing}
\frannie{Talk about how the datasets were parsed? No duplicated hyperedges for the same interaction} \phil{That would belong in the place where we are introducing the data sets, roughly \Cref{sec:sem-empirical}}
